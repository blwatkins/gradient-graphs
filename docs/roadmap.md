...
- [x] Conversion of project files from static HTML, CSS, and JavaScript to a Node.js project in TypeScript with dependency management and build scripts
